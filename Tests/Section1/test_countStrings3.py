...
import sys
import io
from Section1.CountStrings3 import main, CountStrings
...
'''
    ...
    def test_case1_line5(self):
        input_str= "(b(((((a|(b|a))*)|(((((a|(a*))|a)|(b|((a|a)*)))|(a*))|(a|a)))*)*))"
        my_class = CountStrings(input_str)
        self.assertEqual(3,my_class.calculate(502014773))

#((((((ab)b)*)*)*)|(((aa)|((a(a|(b*)))b))|(((b|a)(b|b))(((b|b)*)(a|(ba)))))) 423422303
